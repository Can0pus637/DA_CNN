...
HD_PWD='C:/Users/Boyang/Desktop/m1_CNN_N/DA_OBC.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log layerX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source layerX.tcl -notrace
