...
HD_PWD='C:/Users/Boyang/Desktop/CNN/m3_CNN_N_8_bit/DA_OBC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Array_Input.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Array_Input.tcl
