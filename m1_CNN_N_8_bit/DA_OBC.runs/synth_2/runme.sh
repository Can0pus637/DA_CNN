...
HD_PWD='C:/Users/Boyang/Desktop/m1_CNN_N/DA_OBC.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log layerX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source layerX.tcl
